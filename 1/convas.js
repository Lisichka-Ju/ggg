    ...
    function updateDots() {
        for(let i   = 1; i < dots.length; i++ ) {
            ...
            for(let j = 0; j < dots.length; j++) {
                ...
                let force = (dist - config.sphereRead) / dist * b.mass;
            ...
            dots[i].vel.x = dots[i].vel.x * config.smmoth + acc.x * dots[i].mass;
            dots[i].vel.y = dots[i].vel.y * config.smmoth + acc.y * dots[i].mass;
        }
